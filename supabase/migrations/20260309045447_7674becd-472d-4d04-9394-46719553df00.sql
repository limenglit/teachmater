...
-- Add student_names column to boards table
ALTER TABLE public.boards ADD COLUMN student_names jsonb DEFAULT '[]'::jsonb;

-- Update the update_board function to support student_names
CREATE OR REPLACE FUNCTION public.update_board(
  p_board_id uuid, p_token text,
  p_title text DEFAULT NULL, p_description text DEFAULT NULL,
  p_view_mode text DEFAULT NULL, p_is_locked boolean DEFAULT NULL,
  p_moderation_enabled boolean DEFAULT NULL, p_columns jsonb DEFAULT NULL,
  p_background_color text DEFAULT NULL, p_banned_words text DEFAULT NULL,
