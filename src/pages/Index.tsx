...
const Index = () => {
  ...
  return (
    <ThemeProvider>
      <StudentProvider>
        <div className="app-shell-safe flex flex-col min-h-[100dvh] lg:h-[100dvh] bg-surface lg:overflow-hidden">
          <WeChatBanner />

          {/* Header */}
          <header className="app-header-safe sticky top-0 z-30 lg:static flex items-center justify-between px-3 sm:px-4 py-0 bg-card border-b border-border">
          ...
          <div className="flex flex-1 min-h-0 lg:overflow-hidden relative">
            ...
            {true ? (
              <div className={`
                app-sidebar-safe fixed top-0 left-0 lg:static lg:top-auto lg:left-auto z-50 lg:z-auto h-[100dvh] lg:h-full min-h-0
            ...
            <div className="app-content-safe flex-1 min-w-0 lg:min-h-0 lg:overflow-y-auto overflow-x-hidden transition-[width] duration-150 ease-out">
              {/* 积分面板后，工具箱前插入社区 */}
