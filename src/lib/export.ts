...
/**
 * Open a new window containing the element's HTML and trigger print.
 */
export function exportToPrint(element: HTMLElement) {
  const html = `
    <html>
      <head>
        <title>Print</title>
...
/**
 * Convert element to PNG data URL (2x scale) for QR sharing.
 */
